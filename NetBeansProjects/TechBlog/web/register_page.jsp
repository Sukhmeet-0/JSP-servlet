...
<html>
    ...
    <body>
        ...
        <main class="d-flex align-items-center primary-background text-white banner-background " style="height:100vh" style="padding-bottom: 50px">
            <div class="container">
                <div class="row ">
                    <div class="col-md-6 offset-md-3">
                        <div class="card-header">
                            <h5 class="text-center"><span class="fa fa-user-circle fa-spin"></span> Register here</h5>
                        </div>
